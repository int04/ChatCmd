...
export interface SubagentRun { id: Id; parentTurnId: Id; parentTaskId?: Id; rootTurnId?: Id; parentName?: string | null; taskId?: Id; name: string; request: string; status: string; createdAtUtc: string; updatedAtUtc: string; completedAtUtc?: string; workerId?: string; attempt: number; leaseExpiresAtUtc?: string; lastHeartbeatAtUtc?: string; maxRuntimeMs: number; startedAtUtc?: string; terminalReason?: string }
export interface SubagentApproval { parentTaskId?: Id; rootTurnId?: Id; parentName?: string | null; activityId: Id; childTaskId: Id; subagentId: Id; agentName: string; parentTurnId: Id; childTurnId?: Id; tool?: string; input?: unknown; createdAtUtc: string }
