...
export function GlobalConversationApprovalQueue() {
  ...
  useEffect(() => {
    ...
    document.title = tr('Approval required');
    return () => {
  ...
  return <Modal title={tr('Approval required')} description={tr('A new ChatGPT Website conversation is waiting for approval before the Agent can execute anything.')} close={() => {}} dismissible={false} dangerous>
