  ...
  return <div>
    ...
    <form className="settings-form" onSubmit={submit}>
      ...
      <div className="settings-tab-panel" role="tabpanel">
        {activeTab === 'account' && <SettingsSection title={tr('Account')} body={tr('Manage your account information and password.')}><AccountSettings /></SettingsSection>}
      ...
      {activeTab !== 'account' && <div className="save-bar"><span role="status">{saved ? tr('Settings saved.') : ''}</span><button className="button primary"><Save />{tr('Save settings')}</button></div>}
    </form>
