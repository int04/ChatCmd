...
const vi: Record<string, string> = {
  ...
  'Payment order created successfully.': 'Tạo đơn nạp tiền thành công.',
  'Click the button below if your browser does not open the payment page automatically.': 'Click vào nút sau nếu như trình duyệt không tự mở trang thanh toán.',
